...
string(REGEX MATCH "^v([0-9]+)\\.([0-9]+)\\.([0-9]+)(\\.([0-9]+))?" QGC_APP_VERSION_MATCH "${QGC_APP_VERSION}")
if(QGC_APP_VERSION_MATCH)
    ...
    set(QGC_APP_VERSION_TWEAK ${CMAKE_MATCH_5})

    set(QGC_APP_VERSION "${QGC_APP_VERSION_MAJOR}.${QGC_APP_VERSION_MINOR}.${QGC_APP_VERSION_PATCH}")
    if(NOT QGC_APP_VERSION_TWEAK STREQUAL "")
        string(APPEND QGC_APP_VERSION ".${QGC_APP_VERSION_TWEAK}")
    endif()
else()
    ...
    set(QGC_APP_VERSION_TWEAK 0)
endif()
# cmake_print_variables(QGC_APP_VERSION QGC_APP_VERSION_MAJOR QGC_APP_VERSION_MINOR QGC_APP_VERSION_PATCH QGC_APP_VERSION_TWEAK)

...
DECLARE_SETTINGSFACT(AIConsoleSettings, oauthAccessToken)
DECLARE_SETTINGSFACT(AIConsoleSettings, oauthRefreshToken)
DECLARE_SETTINGSFACT(AIConsoleSettings, oauthTokenExpiresAtUtc)
